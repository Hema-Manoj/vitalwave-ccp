...
export default function HospitalSignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Save hospital profile to database
      console.log("[v0] Saving hospital profile to database...")
      await set(ref(getFirebaseDatabase(), `hospitals/${userId}`), {
        id: userId,
        ...
        <Card className="border-2">
          <CardHeader className="space-y-3 text-center">
            ...
            <div className="flex items-center justify-center gap-2">
              ...
              <CardTitle className="text-2xl">VitalWave Hospital</CardTitle>
            </div>
            <CardDescription className="text-base">Create your hospital account</CardDescription>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              <div className="text-center text-sm text-muted-foreground">
                ...
                <Link href="/hospital/login" className="text-primary hover:underline font-medium">
                  Login
                </Link>
              </div>
            </form>
